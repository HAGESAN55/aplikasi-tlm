    ...
    <table class="table-data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding: 5px"><b>Rp. <?php echo e($total); ?>,-</b></td> 
            </tr>
                <tr>
                    <td colspan="4" align="right" style="padding: 5px"><b>Uang Bayar</b></td>
                    <td style="padding: 5px"><b>Rp. <?php echo e(number_format($transaksi[0]->uang_bayar, 0, ',', '.')); ?>,-</b></td>
                </tr>
                <tr>
                    <td colspan="4" align="right" style="padding: 5px"><b>Uang Kembali</b></td>
                    <td style="padding: 5px"><b>Rp. <?php echo e(number_format($transaksi[0]->uang_kembali, 0, ',', '.')); ?>,-</b></td>
                </tr>
        </tbody>
    </table>
...
</html><?php /**PATH C:\xampp-hb-web\htdocs\telm\resources\views/print/kwitansi.blade.php ENDPATH**/ ?>